...
This repository includes official Scottish Government budget workbooks and
derived JSON extracts in `data/`.

The source public sector information is licensed under the Open Government
Licence v3.0:
